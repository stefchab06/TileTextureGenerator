...
public sealed class HorizontalFloorTransformation : TransformationBase
{
    ...
    /// <summary>
    /// Icon for this transformation type (PNG, 32x32 or 64x64).
    /// Path: Resources/Images/Transformations/flat_horizontal.png
    /// </summary>
    public override byte[]? Icon => null; // TODO: Load from embedded resource
